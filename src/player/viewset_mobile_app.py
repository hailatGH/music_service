...
class DataByUserId(viewsets.ModelViewSet):
    ...
    #     #     query_obj = ArtistModel.objects.filter(created_by=id).values('id','artist_name', 'artist_title', 'artist_cover', 'artist_description', 'user_id', 'created_by', 'created_at', 'updated_at')
    #     # except:
    #     #     query_obj = []
    #     return Response("query_obj")

# class AlbumByUserId(viewsets.ModelViewSet):
...
#         try:
#             id = request.query_params['id']
#             query_obj = AlbumModel.objects.filter(created_by=id).values('id','album_title', 'album_cover', 'album_description', 'artist_id', 'album_price', 'user_id', 'created_by', 'created_at', 'updated_at')
#         except:
#             query_obj = []
#         return Response(query_obj)

# class TrackByUserId(viewsets.ModelViewSet):
...
#         try:
#             id = request.query_params['id']
#             query_obj = TrackModel.objects.filter(created_by=id).values('id', 'track_name', 'track_description', 'track_file', 'track_cover', 'track_status', 'track_release_date', 'artist_id', 'album_id', 'genre_id', 'track_price', 'user_id', 'created_by', 'created_at', 'updated_at')
#         except:
#             query_obj = []
#         return Response(query_obj)
