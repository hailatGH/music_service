# Generated by Django 4.1 on 2022-09-20 13:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('album_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='player.albumsmodel')),
                ('artist_id', models.ManyToManyField(to='player.artistsmodel')),
                ('genre_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='player.genresmodel')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.AddField(
            ...
            name='artist_id',
            field=models.ManyToManyField(to='player.artistsmodel'),
        ),
    ]
